#!/usr/bin/env python3
"""Cache conditional SwiftVR endpoint velocities for deterministic train views."""
...
def main() -> int:
    ...
    sample_limit = len(dataset) if args.max_samples is None else min(
    ...
    for batch_cpu in loader:
        ...
        for local_index in range(int(velocities.shape[0])):
            ...
            processed += 1
            print(
                f"cached {processed}/{sample_limit}: {identity['record_uid']} "
